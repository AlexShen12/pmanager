...
def update_user(
    db: Session, user_update: UserUpdate, user_id: int
) -> User:  # really neeed to remember implementing hashing
...
def update_cred(db: Session, cred_id: int, cred_update: CredentialUpdate) -> Credential:
